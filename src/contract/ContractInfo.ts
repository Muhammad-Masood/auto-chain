...
export const rentalABI = [
  {
    inputs: [
      { internalType: "address", name: "_erc20tokenAddress", type: "address" },
    ],
  ...
  { inputs: [], name: "NotForRent", type: "error" },
  {
    inputs: [{ internalType: "address", name: "owner", type: "address" }],
  ...
  { inputs: [], name: "RentTransferFailed", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
    ...
    inputs: [
      { internalType: "uint256", name: "_tokenId", type: "uint256" },
      {
        components: [
          ...
          { internalType: "uint256", name: "durationFrom", type: "uint256" },
          { internalType: "uint256", name: "durationTill", type: "uint256" },
          { internalType: "string", name: "terms", type: "string" },
        ],
        internalType: "struct AutoChainRental.RentalDetails",
        name: "_rentalDetails",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_tokenId", type: "uint256" },
      { internalType: "string", name: "_update", type: "string" },
    ],
    name: "updateMaintenanceHistory",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
